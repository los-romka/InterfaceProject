$.fn.tableRepresentation = function(options) {
    ...
    var info = IrParser().toJson( this.data('tpir-info') )

    meta.children[0].interface_specifier = INTERFACE_SPECIFIER.TABLE;
    meta.children[0].specifiers.push( SPECIFIER.PROXY );

    meta.children[0].children[0].interface_specifier = INTERFACE_SPECIFIER[ settings.orientation ];
    //meta.children[0].children[0].specifiers.push( SPECIFIER.PROXY );
